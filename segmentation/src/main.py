...
def main(args):
    ...
    checkpoint = torch.load(os.path.join("/content/seg_baseline", "models/segmentation_model.pth"), map_location=torch.device('cuda:0'))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--path_to_data', default='/content/train_data', type=str, help='Path to directory with images and masks folders.')
